...
{
    public class CryptoCurrencyEntity : IEntityClass
    {
        [Key]
        ...
        private CryptoCurrencyEntity() { }
        private CryptoCurrencyEntity(ReqSaveCurrentCurrencyInforDto dto)
        {
        ...
        public static CryptoCurrencyEntity Create(ReqSaveCurrentCurrencyInforDto dto)
        {
            return new CryptoCurrencyEntity(dto);
        }
    }
}